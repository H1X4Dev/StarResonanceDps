namespace StarResonanceDpsAnalysis.Forms
{
    partial class HistoricalBattlesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            select2.Items.AddRange(new object[] { "Sort by Damage", "Sort by Healing", "Sort by Taken" });
            select2.List = true;
            ...
            segmentedItem1.Text = "Single-Battle Damage Records";
            segmentedItem2.Text = "Full-Session Damage Records";
            ...
            label2.TabIndex = 24;
            label2.Text = "Team Total Healing";
            // 
            // label3
            // 
